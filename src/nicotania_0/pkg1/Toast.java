...
//    private static final Logger log = LoggerFactory.getLogger(Toast.class);
    ...
    private void tryShow() {
        ...
        if (alreadyShowing) {
            ...
            if (toastQueue.offer(this)) {
                System.out.println("toast enqueued: {}"+ this);
            } else {
                System.out.println("toast queue exceeded it's capacity");
            }
        } else {
            alreadyShowing = true;
            doShow();
    ...
    private void doShow() {
        System.out.println("show toast: {}"+ this);
        if (window != null) {
            if (autoCenter) {
    ...
    @Override
    public void hide() {
        System.out.println("hide toast: {}"+ this);
        if (hideTimer != null) {
    ...
    private void doHide() {
        ...
        if (toastQueue.isEmpty()) {
            ...
            System.out.println("toast unqueued: {}"+ toast);
