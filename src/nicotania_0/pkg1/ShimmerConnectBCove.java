...
import static com.shimmerresearch.bluetooth.ShimmerBluetooth.STATE_CONNECTED;
import static com.shimmerresearch.bluetooth.ShimmerBluetooth.STATE_CONNECTING;
...
//                mShimmer.connect(textFieldComPort.getText(), "default");
                
//                if (conn==null){

		try {
                        System.out.println("about to conn");
			StreamConnection conn = (StreamConnection)Connector.open(textFieldComPort.getText());
                        System.out.println("conn success");
			InputStream mIN = conn.openInputStream();
			OutputStream mOUT = conn.openOutputStream();
                        ShimmerPCBTBCove sbt = new ShimmerPCBTBCove ("blah", false);
			sbt.initializeBoilerPlate();
                        System.out.println("initialized BoilerPlate");
                        sbt.readSamplingRate();
        ...
        textFieldComPort.setText("00:06:66:46:B6:A7");
